...
[![Status](https://img.shields.io/badge/status-pre--release-orange)](#roadmap--upcoming-features)
...
> **Note:** Full API documentation covering `EngineConfig` options, difficulty levels, and roster rules will be published as the library approaches v1.0. A [project wiki](../../wiki) with a full enum reference and technical deep-dives is planned as well.
